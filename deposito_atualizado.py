...
def depositar(saldo, valor, extrato, /):
  if valor > 0:
    ...
    print("\n")
    print("\n")
    print(f"\t{style.GREEN}=== Depósito  realizado com sucesso! ==={style.RESET}")
    print("\n")
    print("\n")
...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
  ...
  if excedeu_saldo:
    ...
    print(f"\t{style.RED}-------------------------------------------------------{style.RESET}")
    print(f"\t@@@ Operação falhou! Você já excedeu o número máximo de saques! @@@")
    print(f"\t{style.RED}-------------------------------------------------------{style.RESET}")
  elif valor > 0:
    saldo -= valor
...
def main():
  ...
  while True:
    ...
    if opcao == "D":
      valor = float(input(f"\t{style.YELLOW}=> Informe o valor de depósito: {style.RESET}"))
